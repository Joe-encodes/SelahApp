...
export function useGospelAudio(chords = [], genre = 'Contemporary', lyrics = []) {
  ...
  const runScheduler = useCallback(() => {
    ...
    const destinations = {
      piano: backingTrackBufferRef.current ? null : pianoGainRef.current,
      percussion: backingTrackBufferRef.current ? null : percussionGainRef.current,
      bass: backingTrackBufferRef.current ? null : bassGainRef.current,
      guitar: backingTrackBufferRef.current ? null : guitarGainRef.current
    };
